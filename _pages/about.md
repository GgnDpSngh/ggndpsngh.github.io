...
I am an Assistant Professor in the Department of Computer Science at the University of Illinois Urbana-Champaign (UIUC) where I lead the FOrmally Certified Automation and Learning (FOCAL) Lab. I also hold an Affiliated Researcher position with VMware Research. My current focus is on combining ideas from Formal Logic, Machine Learning, and Systems research to **construct intelligent compute systems with formal guarantees about their behavior and safety**. Some of our current projects are 1.  Robust and Efficient Deep Reinforcement Learning, 2. Scalable Neural Network Verification, 3. NeuroSymbolic Analysis, 4. Robustness against Common Corruptions in Vision, 4. Provably Robust Machine Learning for Wireless, 5. Trustworthy Machine Learning for Systems, 6. Static Analysis for Differentiable Programs, 7. Safety of Large Language Models, and 8 Neural Network Explanations.
