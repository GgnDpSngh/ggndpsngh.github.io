...
I am an Assistant Professor in the Department of Computer Science at the University of Illinois Urbana-Champaign (UIUC), where I lead the FOrmally Certified Automation and Learning (FOCAL) Lab. Our group has a unique combination of expertise in machine learning, formal methods, mechanistic interpretability, and AI safety. We have been at the forefront of advancing Trustworthy AI, pioneering state-of-the-art methods for **formal verification, synthesis, monitoring, and interpreting frontier AI systems**. We have also made automated reasoning methods based on abstract interpretation for deterministic and probabilistic computations more scalable, precise, and easier to develop and use. Our group has received awards and fellowships from **NSF**, **Amazon**, **Google**, **Qualcomm**, **Bloomberg**, **Anthropic**, **AMD**, **CapitalOne**, and **Open Philanthropy**. Some of the topics (in no particular order) that we currently work on are 
<ul>
   <li>Formal Verification of LLMs, VLMs, and Agents </li>
  <li> Constrained LLM Generation with Rich, Semantic Constraints</li>
...
<ul>
  ...
  <li>
    ...
    <li>
    16 Jan 2025: Congratulations to <a href="https://sgomber.github.io/"> Shaurya Gomber</a> for winning the <a href="https://siebelschool.illinois.edu/about/awards/graduate-fellowships-awards/david-j-kuck-outstanding-thesis-awards">  David J. Kuck Outstanding Master’s Thesis Award</a> for his work on <a href="https://www.ideals.illinois.edu/items/131524">Neural Abstract Interpretation</a>. 
  </li>
  <li>
